...
export const COUNTRY_OPTIONS: CountryOption[] = [
    ...
    { iso: "AX", name: "Åland Islands", code: "+358" },
    ...
    { iso: "HK", name: "Hong Kong SAR China", code: "+852" },
    ...
    { iso: "MO", name: "Macau SAR China", code: "+853" },
    ...
    { iso: "MM", name: "Myanmar (Burma)", code: "+95" },
    ...
    { iso: "PS", name: "Palestinian Territories", code: "+970" },
    ...
    { iso: "GS", name: "South Georgia & South Sandwich Islands", code: "+500" },
