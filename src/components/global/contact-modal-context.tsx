...
export const ContactModalProvider = ({ children }: ContactModalProviderProps) => {
    ...
    return (
        <ContactModalContext.Provider value={value}>
            ...
            >
                <DialogContent className="w-[min(100vw-2rem,640px)] max-w-2xl gap-6 border border-foreground/10 bg-background/95 p-6 sm:p-8 backdrop-blur-md fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-h-[calc(100vh-8rem)] sm:max-h-[calc(100vh-2rem)] overflow-y-auto">
                    <DialogHeader>
                        ...
                        <div className="grid gap-2">
                            ...
                            <div className="flex flex-col gap-3 sm:flex-row">
                                ...
                                >
                                    ...
                                    <SelectContent className="max-h-[280px] z-[10000]">
                                        <div className="p-1">
                                            <Input
                                                value={countryQuery}
