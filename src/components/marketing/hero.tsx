        ...
        <section id="hero" className="flex flex-col items-center text-center w-full max-w-5xl my-24 mx-auto z-40 relative scroll-mt-32">
            <Container delay={0.0}>
                <div className="pl-2 pr-1 py-1 rounded-full border border-foreground/10 hover:border-foreground/15 backdrop-blur-lg cursor-pointer flex items-center gap-2.5 select-none w-max mx-auto">
                    ...
                    <span className="inline-flex items-center justify-center gap-2 animate-text-gradient animate-background-shine bg-gradient-to-r from-[#b2a8fd] via-[#8678f9] to-[#c7d2fe] bg-[200%_auto] bg-clip-text text-sm text-transparent pr-2">
                        Build for the future
                    </span>
                </div>
            </Container>
            <BlurText
                word={"The ultimate solution\n for your business"}
            ...
            <Container delay={0.1}>
                <p className="text-sm sm:text-base lg:text-lg mt-4 text-accent-foreground/60 max-w-2xl mx-auto">
                    Up-Scale your company with our client specific solutions. <span className="hidden sm:inline">SyncSolutions is the all-in-one solution for your company needs.</span>
                </p>
            </Container>
            <Container delay={0.2}>
